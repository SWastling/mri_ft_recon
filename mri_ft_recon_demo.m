% Demonstration of artefacts in MRI reconstruction using the 2D Fourier 
% transform
...
% demonstrate the effect of apply a low-pass filter or only acquiring the 
...
% demonstrate the effect of apply a high-pass filter or only acquiring the 
% edges of k-space
...
% demonstrate the effect of sub-sampling k-space i.e. acquiring every
% second phase encode line leading to wrap
...
% demonstrate the effect of spike-noise i.e. one point in k-space with a 
% high amplitude
k_space_spk = k_space;
...
% demonstrate the effect of noise at one frequency during every phase
% encode step i.e. the zipper artefact
...
% demonstrate the effect of narrowband noise
...
% demonstrate the effect of broadband noise
...
% demonstrate the effect subject motion during data acquisition
